...
public class SMSBackupRestoreActivity extends Activity{
	...
	public void backupMessages(View view) {
		if(!(Environment.getExternalStorageState() != Environment.MEDIA_MOUNTED
				||Environment.getExternalStorageState() != Environment.MEDIA_SHARED)) {
	...
	private String getFileNameForPersistence() {
		return Environment.getExternalStorageDirectory().getAbsolutePath()+File.separator+MESSAGE_FILE_PREFIX+
